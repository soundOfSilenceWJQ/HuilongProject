...
class StockPredictor(nn.Module):
    def __init__(self, d_model=246, nhead=2, num_encoder_layers=1, num_decoder_layers=1):
...
if __name__ == '__main__':
    ...
    for year in range(2009, 2013):  # 从2010开始滚动，到2022
        ...
        fac_num = len(factor_cols)  # 根据训练数据更新input_size
        ...
        # 初始化新的模型实例
        model = StockPredictor(d_model=fac_num)
